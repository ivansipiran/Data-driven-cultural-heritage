...
from models.msn_model import MSN_Original
...
parser.add_argument('--visualize', type=bool, default = False,  help='bool visualize')
...
dir_name, logname  = save_paths(opt.model, "train_MSN", "ShapeNetDataset", "hole_residual")
...
network = MSN_Original(opt.num_points, device).to(device)
...
for epoch in range(opt.nepoch):
    ...
    for i, data in enumerate(dataloader_train, 0):
        ...
        output, output2, rec_loss1, rec_loss2, exp_loss = network(in_partial, in_complete, 0.005, 50)
